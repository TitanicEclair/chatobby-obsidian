import type { ProjectErrorV1 } from "./errors.js";
import type { BindingId, DirectoryCandidateRef, DirectoryId, ProjectCommandId, ProjectEventId, ProjectId, ProjectReceiptId, RootId, RootOperationId, SessionId, SessionPreflightReceiptId, VaultId } from "./ids.js";
import type { DirectoryDeviceBindingV1, DirectoryMarkerIndexV1, ProjectBriefMetadataV1, ProjectDefaultsV1, ProjectRecordV1, ProjectRootLocationV1, RootMutationKindV1, RootRecoveryResultV1, SessionWorkspaceBindingV1 } from "./models.js";
...
export type ProjectCommandV1 = (ProjectCommandEnvelopeV1 & {
...
export type ProjectEventV1 = (ProjectEventEnvelopeV1 & {
...
export declare function projectProjectSummary(record: ProjectRecordV1, brief?: ProjectBriefMetadataV1): ProjectSummaryProjectionV1;
export declare function projectProjectDetail(project: ProjectRecordV1, bindings: readonly DirectoryDeviceBindingV1[], sessionBindings: readonly SessionWorkspaceBindingV1[], brief?: ProjectBriefMetadataV1): ProjectDetailProjectionV1;
export declare function projectDirectoryBinding(binding: DirectoryDeviceBindingV1): DirectoryBindingProjectionV1;
export declare function projectProjectStructure(project: ProjectRecordV1, options?: {
