import type { BindingId, DeviceId, DirectoryCandidateRef, DirectoryId, DirectoryObservationId, ProjectCommandId, ProjectId, RootId, RootOperationId, SessionId, VaultId } from "./ids.js";
...
export declare const DIRECTORY_BINDING_HISTORY_LIMIT: 32;
...
export type RootMutationKindV1 = "create" | "register" | "add" | "relabel" | "set-primary" | "remove" | "relink" | "repair" | "assign-new-identity";
...
export interface RootOperationArtifactV1 {
    readonly resource: "project-record" | "directory" | "directory-marker" | "device-binding" | "marker-index" | "recovery-plan";
