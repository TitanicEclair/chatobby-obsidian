...
export declare const OBSIDIAN_BROWSER_OPERATIONS: readonly ["browser.open", "browser.navigate", "browser.list", "browser.snapshot", "browser.read", "browser.click", "browser.type", "browser.wait", "browser.evaluate", "browser.close"];
