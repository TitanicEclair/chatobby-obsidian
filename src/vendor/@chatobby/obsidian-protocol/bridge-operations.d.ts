...
export declare const OBSIDIAN_BROWSER_OPERATIONS: readonly ["browser.open", "browser.navigate", "browser.list", "browser.snapshot", "browser.read", "browser.dom", "browser.click", "browser.type", "browser.press", "browser.wait", "browser.screenshot", "browser.close"];
