...
export type ObsidianCliToolGroup = "obsidian.cli.content" | "obsidian.cli.manage" | "obsidian.diagnostics";

/** Canonical deferred-discovery group for runtime-owned Obsidian CLI tools. */
export function obsidianCliToolGroup(
	name: ObsidianCliFamilyToolName | ObsidianCliSubstrateToolName,
